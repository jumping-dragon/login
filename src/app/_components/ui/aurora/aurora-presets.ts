...
export const BUILT_IN_TEMPLATES: ReadonlyArray<{ name: AuroraVariant } & PaletteSettings> = [
  {
    name: "Original",
  ...
  },
  {
    ...
    stopPositions: { aurora1: 0, aurora2: 13, aurora3: 32, aurora4: 57, aurora5: 84 },
    invertFilter: false,
    blendMode: "overlay",
    opacity: 0.7,
    blur: 25,
...
export function palettePreviewGradient(settings: Pick<PaletteSettings, "colors" | "stopPositions">) {
